...
import static cc.yfree.yangf.everyday.RoutePlanningActivity.activityList;
...
public class BNDemoGuideActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (intent != null) {
			...
			if (bundle != null) {
				mBNRoutePlanNode = (BNRoutePlanNode) bundle.getSerializable(RoutePlanningActivity.ROUTE_PLAN_NODE);
			}
		}
		//显示自定义图标
		if (hd != null) {
	...
	protected void onDestroy() {
		...
		RoutePlanningActivity.activityList.remove(this);
